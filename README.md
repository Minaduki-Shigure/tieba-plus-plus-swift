...
| TiebaLite parity | Current `main` and public `v0.64.0-alpha.5`: about 81% overall (estimated range 80–82%, with 18–20% remaining). Anonymous reading and media remain about 91–95% |
| Distribution | The public SideStore/LiveContainer source currently serves `v0.64.0-alpha.5` (build 80) |
...
- **Current alpha:** `v0.64.0-alpha.5` publishes the account-bound followed-
  forum today-check-in marks described above, including monotonic same-day
  reconciliation, bounded foreground refresh, active UTC+8 expiry, and strict
  forum-identity validation. It retains `v0.64.0-alpha.4`'s independent OLED
...
- **App source:** Add [`sidestore-source.json`](https://raw.githubusercontent.com/Minaduki-Shigure/tieba-plus-plus-swift/main/sidestore-source.json)
  ...
  The source currently distributes the verified `v0.64.0-alpha.5` IPA (build 80).
...
- **Detailed parity:** See [`ROADMAP.md`](ROADMAP.md) for the complete TiebaLite
  ...
  The public `v0.64.0-alpha.5` app-code snapshot matches the current 80–82%
