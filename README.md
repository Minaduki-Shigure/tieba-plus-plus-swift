...
| TiebaLite parity | Current `main` and public `v0.65.0-alpha.5`: about 81% overall (estimated range 80–82%, with 18–20% remaining). Anonymous reading and media remain about 91–95% |
| Distribution | The public SideStore/LiveContainer source currently serves `v0.65.0-alpha.5` (build 83) |
...
- **`v0.65.0-alpha.5` list and gallery interaction:** Home's Explore shortcut now uses
...
- **Current alpha:** `v0.65.0-alpha.5` publishes the four-root Home, Explore,
...
- **App source:** Add [`sidestore-source.json`](https://raw.githubusercontent.com/Minaduki-Shigure/tieba-plus-plus-swift/main/sidestore-source.json)
  ...
  The source currently distributes the verified `v0.65.0-alpha.5` IPA (build 83).
...
- **Detailed parity:** See [`ROADMAP.md`](ROADMAP.md) for the complete TiebaLite
  ...
  The public `v0.65.0-alpha.5` app-code snapshot has the same 80–82% weighted
