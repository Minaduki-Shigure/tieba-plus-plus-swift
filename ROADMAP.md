...
currently serves `v0.65.0-alpha.4` (build 83), whose app-code snapshot includes
...
validation gate.
Published `v0.65.0-alpha.4` interaction polish expands Home's Explore shortcut
...
The public `v0.65.0-alpha.4` app-code snapshot is at 80–82%; all experimental
