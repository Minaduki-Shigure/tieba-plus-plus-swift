...
currently serves `v0.65.0-alpha.3` (build 83), whose app-code snapshot includes
...
validation gate.
Published `v0.65.0-alpha.3` interaction polish expands Home's Explore shortcut
...
The public `v0.65.0-alpha.3` app-code snapshot is at 80–82%; all experimental
